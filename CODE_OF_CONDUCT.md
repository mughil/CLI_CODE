...
CLI_CODE is a **data** project. Two additional expectations apply:

* **Do not fabricate data.** Never submit a tool, model, licence, benchmark,
  star count or capability you have not verified from a primary source. "Unknown"
  is always better than a guess.
* **Do not use the project for promotion.** Submitting your own tool is welcome
  and normal; submitting it with inflated or unverifiable claims is not.
...
issues, pull requests, discussions and releases — and also applies when an
...
[private security advisory](https://github.com/mughil/CLI_CODE/security/advisories/new)
(which is not publicly visible) or, for non-sensitive reports, by opening an
